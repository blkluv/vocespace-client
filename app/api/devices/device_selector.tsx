...
import { LocalAudioTrack, LocalVideoTrack, RoomEvent, Track } from 'livekit-client';
    ...
    useEffect(() => {
      if (enabled) {
        navigator.mediaDevices
          .getUserMedia({ audio: kind === MediaDeviceKind.AudioInput, video: kind === MediaDeviceKind.VideoInput })
          .then(() => {

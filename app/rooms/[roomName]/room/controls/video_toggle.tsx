...
export function VideoToggle({ enabled, onClicked, showText = true }: ToggleProps) {
  const on_clicked = () => {
    onClicked(enabled);
  };
    ...
    <div>
      {showText ? (
        ...
        >
          ...
          >
            {enabled ? (
              <SvgResource type="video" svgSize={16}></SvgResource>
            ) : (
              <SvgResource type="video_close" svgSize={16}></SvgResource>
            )}
          </Button>
